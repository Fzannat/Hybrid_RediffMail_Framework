package com.qa.rediffmail.TestBase;
...
public class TestBase {
    ...
    public TestBase() throws Exception {
        prop = new Properties();
        ip = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/com/qa/rediffmail/Config/Config.properties");
        prop.load(ip);

        dataprop = new Properties();
        ip = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/com/qa/rediffmail/Config/TestData.properties");
        dataprop.load(ip);
    }
